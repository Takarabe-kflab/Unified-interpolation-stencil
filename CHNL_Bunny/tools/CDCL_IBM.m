...
x_zoom = zeros(Nx,Ny,Nz);
y_zoom = zeros(Nx,Ny,Nz);
z_zoom = zeros(Nx,Ny,Nz);
...
for k=1:Nz
    for j=1:Ny
        for i=1:Nx
            x_zoom(i,j,k) = x(xshift+i,yshift+j,zshift+k);
            y_zoom(i,j,k) = y(xshift+i,yshift+j,zshift+k);
            z_zoom(i,j,k) = z(xshift+i,yshift+j,zshift+k);
            u_zoom(i,j,k) = u(xshift+i,yshift+j,zshift+k);
            v_zoom(i,j,k) = v(xshift+i,yshift+j,zshift+k);
            w_zoom(i,j,k) = w(xshift+i,yshift+j,zshift+k);
            p_zoom(i,j,k) = p(xshift+i,yshift+j,zshift+k);
        end
    end
end
% --------------------------------------------------------------------
...
dragforce = moment + pressure - viscousity;
